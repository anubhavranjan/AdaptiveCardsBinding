...
namespace IO.Adaptivecards.Renderer.Readonly
{
 ...
 //	// Metadata.xml XPath method reference: path="/api/package[@name='io.adaptivecards.renderer']/class[@name='BackgroundImageLoaderAsync']/method[@name='doInBackground' and count(parameter)=1 and parameter[1][@type='java.lang.String...']]"
 //	protected global::Java.Lang.Object? DoInBackground(params Object[]? args)
 //	{
